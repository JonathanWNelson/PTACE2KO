---
title: "PT ACE2 KO 2582 Ambient RNA and Doublet Removal"
...
tod = Read10X_h5(here("Cell Ranger Files", "5_raw_feature_bc_matrix.h5")) #Change
toc = Read10X_h5(here("Cell Ranger Files", "5_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("Cell Ranger Files", "5_filtered_feature_bc_matrix.h5")) #Change 
...
#32285 features across 12524 samples within 1 assay 
...
DimHeatmap(seurat.obj.f,dims=pcs, cells=500)

# Based on the pcs calculated above, use 16
...
nExp_poi <- round(0.096*nrow(seurat.obj.f@meta.data)) #Change
nExp_poi
...
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "2582", col.name = "Sample_ID") #Change
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "Cre +", col.name = "Genotype") #Change
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "Saline", col.name = "Treatment") #Change
...
saveRDS(seurat.obj.f_singlets, here("Temp Outputs", "2582.rds")) #Change
