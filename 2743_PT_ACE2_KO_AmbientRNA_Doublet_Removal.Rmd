---
title: "PT ACE2 KO 2743 Ambient RNA and Doublet Removal"
...
tod = Read10X_h5(here("Cell Ranger Files", "4_raw_feature_bc_matrix.h5")) #Change
toc = Read10X_h5(here("Cell Ranger Files", "4_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("Cell Ranger Files", "4_filtered_feature_bc_matrix.h5")) #Change 
...
nExp_poi <- (0.104*nrow(seurat.obj.f@meta.data)) #Change
nExp_poi
...
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "2743", col.name = "Sample_ID") #Change
...
saveRDS(seurat.obj.f_singlets, here("Temp Outputs", "2743.rds")) #Change
