---
title: '"PT ACE2 KO 2701 Ambient RNA and Doublet Removal'
...
tod = Read10X_h5(here("Cell Ranger Files", "6_raw_feature_bc_matrix.h5")) #Change
toc = Read10X_h5(here("Cell Ranger Files", "6_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("Cell Ranger Files", "6_filtered_feature_bc_matrix.h5")) #Change 
...
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "2701", col.name = "Sample_ID") #Change
...
saveRDS(seurat.obj.f_singlets, here("Temp Outputs", "2701.rds")) #Change
