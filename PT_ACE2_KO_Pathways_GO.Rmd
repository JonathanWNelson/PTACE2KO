...
author: "Jonathan Nelson & Jackie Emathinger"
...
Comp1pos_go <- pos_go
saveRDS(Comp1pos_go, here("Temp Outputs", "Comp1posgo.rds")) #Change
...
dotplot(neg_go, split="ONTOLOGY") +
  facet_grid(ONTOLOGY~., scale="free") +
  ggtitle("KO Saline vs. Control Saline Downregulated Pathways") +
  theme_bw() +  # You can use a different theme if needed
  theme(
    plot.title = element_text(hjust = 0.5, size = 12),  # Adjust title font size
...
Comp1neg_go <- neg_go
saveRDS(Comp1neg_go, here("Temp Outputs", "Comp1neggo.rds")) #Change
...
write.xlsx(AllPT_Comp2, file = here("KOvCtrl_AngII_All2.xlsx"))
...
Comp2pos_go <- pos_go
saveRDS(Comp2pos_go, here("Temp Outputs", "Comp2posgo.rds")) #Change
...
Comp2neg_go <- neg_go
saveRDS(Comp2neg_go, here("Temp Outputs", "Comp2neggo.rds")) #Change
