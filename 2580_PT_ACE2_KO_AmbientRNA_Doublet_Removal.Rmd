---
title: "PT ACE2 KO 2580 Ambient RNA and Doublet Removal"
author: "Jackie Emathinger and Jonathan Nelson"
...
tod = Read10X_h5(here("Cell Ranger Files", "2_raw_feature_bc_matrix.h5")) #Change
toc = Read10X_h5(here("Cell Ranger Files", "2_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("Cell Ranger Files", "2_filtered_feature_bc_matrix.h5")) #Change 
...
DimHeatmap(seurat.obj.f,dims=1:16, cells=500)

# Based on the pcs calculated above, use pcs calculated above
...
nExp_poi <- round(0.088*nrow(seurat.obj.f@meta.data)) #Change
nExp_poi
...
# Let's look a little deeper at what is being considered a doublet
```{r doublet_finder2, echo=TRUE, warning=FALSE, error=FALSE, message=FALSE, fig.align = 'center'}
# Run canonical markers by DF.class
...
# plot features based on the doublet vs singlet
DotPlot(seurat.obj.f_doublets, features =  markers.to.plot1, group.by = "DF.class")



# DotPlot on the singlets to determine if clusters express multiple cell type markers
DotPlot(seurat.obj.f_singlets, features= markers.to.plot1)

# cluster 2 has a mixed expression profile, with markers pertaining to PT, pericytes, TAL, and Endo. 

FeaturePlot(seurat.obj.f_singlets, reduction = "umap",  features= c(
                      "Slc5a12",      # PT-S1
                      "Lrp2",         # PT
                      "Flt1",         # Endo
                      "Slc12a1",      # TAL
...
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "2580", col.name = "Sample_ID") #Change
...
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "First", col.name = "Cohort") #Change
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "JWN", col.name = "Sample_Processor") #Change
...
saveRDS(seurat.obj.f_singlets, here("Temp Outputs", "2580.rds")) #Change
