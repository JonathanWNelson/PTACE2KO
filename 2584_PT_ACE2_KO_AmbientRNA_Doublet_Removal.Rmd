---
title: "PT ACE2 KO 2584 Ambient RNA and Doublet Removal"
...
tod = Read10X_h5(here("Cell Ranger Files", "1_raw_feature_bc_matrix.h5")) #Change
toc = Read10X_h5(here("Cell Ranger Files", "1_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("Cell Ranger Files", "1_filtered_feature_bc_matrix.h5")) #Change 
...
DimHeatmap(seurat.obj.f,dims=1:18, cells=500)

# Based on the pcs calculated above, use 18
...
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "2584", col.name = "Sample_ID") #Change
...
saveRDS(seurat.obj.f_singlets, here("Temp Outputs", "2584.rds")) #Change
